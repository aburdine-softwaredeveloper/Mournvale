...
async function main(): Promise<void> {
  ...
  console.log("  ok — v1 save migrates and backfills progression + social + inventory");

  // ── Round-trip a v4 save with progression, relationships AND inventory ──
  ...
  await store.save(playerId, 2, buildSaveData(loaded!.character, "tavern", prog, social, inventory));
  ...
  console.log("  ok — v4 save round-trips progression + social + inventory");
